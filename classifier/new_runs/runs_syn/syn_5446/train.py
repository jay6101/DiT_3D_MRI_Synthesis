...
def train_model(hyperparams, modelname):
    ...
    for fold_idx in range(1):
        ...
        train_dataset = MRIDataset(train_df, hyperparams, train=True, num_samples=None, num_synth_samples=int(2723*2))
...
if __name__ == "__main__":
    hyperparams = {
        ...
        'num_epochs': 100,
        'dropout_rate': 0.3,
        'runs_dir': '/space/mcdonald-syn01/1/projects/jsawant/Diffusion_paper/classifier/new_runs/runs_syn',
        'val_split': 0.37,
