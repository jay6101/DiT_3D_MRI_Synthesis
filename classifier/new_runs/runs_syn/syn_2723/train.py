...
def train_model(hyperparams, modelname):
    ...
    for fold_idx in range(1):
        ...
        train_dataset = MRIDataset(train_df, hyperparams, train=True)
...
if __name__ == "__main__":
    hyperparams = {
        'train_csv': "/space/mcdonald-syn01/1/projects/jsawant/DSC250/data_csvs/train.csv",
        'test_csv': "/space/mcdonald-syn01/1/projects/jsawant/DSC250/data_csvs/val.csv",
        'device': torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'),
        'batch_size': 128,
        'learning_rate': 1e-4,
        'num_epochs': 100,
        'dropout_rate': 0.5,
        'runs_dir': '/space/mcdonald-syn01/1/projects/jsawant/DSC250/classifier/runs',
        'val_split': 0.37,
        ...
        'cosine_t0': 20,  # Number of epochs for first restart
        ...
        'synth_hc_folder_path':"/space/mcdonald-syn01/1/projects/jsawant/DSC250/synthetic_data_pkls_HC",
        'synth_tle_folder_path':"/space/mcdonald-syn01/1/projects/jsawant/DSC250/synthetic_data_pkls_TLE",
    }
