...
def train_vae_gan(hparams):
    ...
    checkpoint = torch.load('/space/mcdonald-syn01/1/projects/jsawant/DSC250/VAE_GAN/best_runs/vae_gan_run_20250222_191400/best_vae_gan.pth', 
    ...
    for epoch in range(hparams['num_epochs']):
        ...
        val_total = val_g_loss #+ val_d_loss
